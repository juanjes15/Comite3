    ...
    @if (Route::has('login'))
        @auth
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="mr-3">
                    <a href="{{ url('/dashboard') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        Dashboard
                    </a>
                </li>
            </ul>
        @else
            ...
            <a href="{{ route('login') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Iniciar sesión
            </a>
        @endauth
    @endif
...
<div class="pt-24">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <img id="logo" class="w-1/2 md:w-4/4 z-50" src="{{ asset('logo/logo1.png') }}" />
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex-shrink-0 text-black">
                <div class="logo-title flex items-center">
                    <img src="{{ asset('/logo/logoSena.png') }}" alt="" style="width: 64px; border-radius: 50%; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.3);">
            ...
            <div class="flex-1 ml-12">
                <div class="block-container">
                    <h2 class="uppercase text-gray-500 mb-4">Puntos de atención <i class="fas fa-phone-alt ml-2"></i></h2>
                    <hr class="w-16 border-gray-500 mb-4">
                    <div style="color: black;">
                        <strong>Contactos</strong><br>
                        <li>Línea nacional, exclusiva para comunicarse con un servidor público SENA: +(57) 601 5461500</li>
                        <li>Línea de atención al empresario: Bogotá +(57) 601 3430101 - Línea gratuita y resto del país 018000 910682</li>
                        <li>Línea de atención al ciudadano: Bogotá +(57) 601 3430111 - Línea gratuita y resto del país 018000 910270</li>
                    </div>
                </div>
            </div>
            <div class="flex-1 ml-12">
                <div class="block-container">
                    <h2 class="uppercase text-gray-500 mb-4">DIRECCIÓN GENERAL <i class="fas fa-map-marker-alt ml-2"></i></h2>
                    <hr class="w-16 border-gray-500 mb-4">
                    <div style="color: black;">
            ...
            <div class="flex-1 ml-12">
                <div class="block-container">
                    ...
                    <ul class="list-reset ml-6" style="color: black;">
                        <li><i class="fas fa-chevron-right mr-2"></i><a href="https://www.sena.edu.co/es-co/sena/Paginas/directorio.aspx" style="color: blue;">Directorio SENA</a></li>
                        <li><i class="fas fa-chevron-right mr-2"></i><a href="https://sciudadanos.sena.edu.co/SolicitudIndex.aspx" style="color: blue;">PQRS</a></li>
                        <li><i class="fas fa-chevron-right mr-2"></i><a href="https://www.sena.edu.co/es-co/ciudadano/Paginas/chat.aspx" style="color: blue;">Chat en línea</a></li>
                        <li><i class="fas fa-chevron-right mr-2"></i><a href="https://www.sena.edu.co/es-co/ciudadano/Paginas/Denuncias_Corrupcion.aspx" style="color: blue;">Denuncias por actos de corrupción</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="flex justify-center items-center mb-8">
        <a href="{{ url('https://www.facebook.com/SENA/') }}" target="_blank" style="color: black; font-size: 24px; margin: 5px;">
            <i class="fab fa-facebook"></i>
        </a>
        <a href="{{ url('https://twitter.com/SENAComunica') }}" target="_blank" style="color: black; font-size: 24px; margin: 5px;">
            <i class="fab fa-twitter"></i>
        </a>
        <a href="{{ url('https://www.instagram.com/senacomunica/') }}" target="_blank" style="color: black; font-size: 24px; margin: 5px;">
            <i class="fab fa-instagram"></i>
        </a>
        <a href="{{ url('https://www.linkedin.com/school/servicio-nacional-de-aprendizaje-sena-/') }}" target="_blank" style="color: black; font-size: 24px; margin: 5px;">
            <i class="fab fa-linkedin"></i>
        </a>
        <a href="{{ url('https://www.youtube.com/user/SENATV') }}" target="_blank" style="color: black; font-size: 24px; margin: 5px;">
    ...
    <div class="bg-gradient-to-r from-green-500 to-blue-500 w-full p-4 rounded-lg">
        <div class="container mx-auto px-8 text-center flex flex-wrap justify-between">
            <p class="text-white text-sm md:w-1/2">&copy; 2023 Servicio Nacional de Aprendizaje SENA. Todos los derechos reservados</p>
