...
class ArticuloReglamento extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            formación, la convivencia en la comunidad educativa, el desempeño académico de sus compañeros, y
            que al presentarse originan la necesidad de una medida formativa y/o sancionatoria.',
            'arti_prohibiciones'=> '2-Realizar fraude en evaluaciones, en el proceso de aprendizaje o en concursos, juegos o
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            'arti_prohibiciones'=> '4-Suplantar identidad durante el proceso de formación.',
            'tpf_id'=> '1',
        ]);
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            'arti_prohibiciones'=> '6-Utilizar de manera irresponsable el internet y las nuevas tecnologías dispuestas por el SENA para su proceso formativo. ',
            'tpf_id'=> '1',
        ]);
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            'arti_prohibiciones'=> '11-Destruir, sustraer, dañar total o parcialmente instalaciones físicas, equipos, materiales, software,
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            'arti_prohibiciones'=> '12-Obstaculizar el ingreso a las instalaciones de los Centros de Formación y/o perturbar el desarrollo
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            'arti_prohibiciones'=> '16-Todo acto que sabotee, perturbe o impida las actividades de formación, administrativas y de
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            5-Alterar, adulterar, falsificar o sustraer documentos oficiales, calificaciones, evaluaciones o firmas
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            comportamental.',
            'arti_prohibiciones' => '9-Utilizar el nombre del SENA, las instalaciones, el internet y nuevas tecnologías, para actividades
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '10- Hurtar, estafar o abusar de la confianza de cualquier integrante de la comunidad educativa, o
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '13-Realizar acciones proselitistas de carácter político o religioso dentro de las instalaciones del SENA
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '14-Permanecer con el uniforme acordado para el programa de formación de la especialidad, en
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '15-Generar, transmitir, publicar o enviar información confidencial, de circulación restringida,
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '17-Realizar comportamientos contrarios a la normativa SENA en lugares donde se adelanten eventos
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '18-Incumplir las normas de convivencia establecidas en cada Centro de Formación o Centro de
            convivencia.',
            'tpf_id'=> '1',
        ]);
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '19-Ingresar o salir de cualquier instalación del Centro de Formación o de la entidad donde se desarrolle
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '20-Elaborar escritos o mensajes satíricos, dibujar y/o escribir sobre cualquier superficie, objeto o
        ...
        DB::table('articuloreglamentos')->insert([
            ...
            una de las prohibiciones, incumple un deber o se extralimita en el ejercicio de sus derechos de carácter
            comportamental.',
            'arti_prohibiciones' => '21-Propiciar conductas, propuestas o actos inmorales hacia cualquier miembro de la comunidad
